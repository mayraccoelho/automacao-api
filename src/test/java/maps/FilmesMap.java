...
public class FilmesMap {
    ...
    public static void initFilme(){
        ...
        filme.put("descricao", "Um alerta vermelho da Interpol é emitido, aquando o agente do FBI John Hartley assume o caso. Durante sua busca, ele se vê diante de um assalto ousado, agora, é forçado a se aliar ao maior ladrão de arte da história, Nolan Booth (Reynolds), para capturar a ladra de arte mais procurada do mundo atualmente, Sarah Black.");
